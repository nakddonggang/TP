			...
			<section class="fullpage SECTION_FULL_PAGE01">
				...
				<!-- 메인 페이지 -->
					...
					<table border="1">
						...
						<tr onclick="location.href='./AdminHBookWrite.am?member_id=<%=hbookLists.getMember_id()%>&hbook_subject=<%=hbookLists.getHbook_subject()%>&hbook_author=<%=hbookLists.getHbook_author()%>'">
